...
FAILURE_POLICIES: Final[dict[str, FailurePolicy]] = {
    ...
    "provider_error": _policy(
        ...
        0,
        True,
        "provider availability or configured model changes",
    ),
    "provider_timeout": _policy(
        ...
        0,
        True,
        "provider latency or configured timeout changes",
    ),
    "partial_stream_interrupted": _policy(
        "provider",
        "pause_for_user",
        False,
        "ambiguous",
        ...
        0,
        True,
        "user chooses a new recovery identity after inspecting partial output",
    ),
    "unsupported_verify_schema": _policy(
        "task",
        "pause_for_user",
        False,
        "none",
        ...
        0,
        True,
        "the canonical VerifyOutcome producer is restored",
    ),
    "completed_turn_integrity_error": _policy(
        "persistence",
        "pause_for_user",
        False,
        "committed",
        "user",
        "completed_turn_integrity",
        0,
        True,
        "the original committed response locator is restored or reconciled",
    ),
    "unsupported_session_schema": _policy(
        "persistence",
        "pause_for_user",
        False,
        "none",
        ...
        0,
        False,
        "a new current-schema Session is created",
    ),
    "workflow_integrity_error": _policy(
        "persistence",
        "pause_for_user",
        False,
        "none",
        ...
        0,
        True,
        "diagnostic files are inspected and current-schema integrity is restored",
    ),
    ...
    "invalid_command": _policy(
        ...
        3,
        False,
        "client supplies a valid command",
    ),
    "empty_results": _policy(
        "request",
        "wait_frontend",
        True,
        "none",
        ...
        3,
        False,
        "client supplies non-empty tool results",
    ),
}
