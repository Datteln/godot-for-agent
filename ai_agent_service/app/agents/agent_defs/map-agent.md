...
tools: [delegate, delegate_many, read_delegate_artifact, read_map_artifact, validate_object_placements, validate_layer_coverage, validate_map_region, capture_viewport_screenshot, save_scene, load_skill, search_tools]
model: inherit
effort: standard
max_turns: 12
