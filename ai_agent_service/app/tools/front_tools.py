                ...
                "parameters": _object_schema(
                    {
                        ...
                        "inspection": {
                            "type": "object",
                            "description": "Bounded visual question generated by the current task LLM. It is validated as data before being sent to the external visual model.",
                            "properties": {
                                "question": {"type": "string", "maxLength": 500},
                                "expected_conditions": {"type": "array", "maxItems": 8, "items": {"type": "string", "maxLength": 200}},
                                "focus": {"type": "string", "maxLength": 240},
                                "dimensions": {"type": "array", "maxItems": 6, "items": {"type": "string", "enum": ["layout", "connectivity", "visibility", "color", "composition", "ui", "geometry"]}},
                            },
                        },
                        "refresh_visual_observation": {"type": "boolean", "description": "Bypass session-local visual observation reuse for this capture."},
                        "output_path": {
                            "type": "string",
                ...
                "parameters": _object_schema(
                    {
                        ...
                        "inspection": {"type": "object", "description": "Optional bounded visual observation request for the automatic screenshot."},
                    },
