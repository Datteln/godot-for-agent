...
const UI_TEXT := {
	"zh": {
		...
		"idle_recovery_failed": "长时间未收到进展，尝试恢复事件流失败（%s），已停止当前请求。",
	...
	"en": {
		...
		"run_allowed": "Run allowed calls",
		"reject_all": "Reject all calls",
		...
		"idle_recovery_failed": "No progress for a long time; event-flow recovery failed (%s), so the request was stopped.",
