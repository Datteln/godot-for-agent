...
const UI_TEXT := {
	"zh": {
		...
		"permission_confirm": "确认",
		"permission_full": "全权限",
		"permission_tooltip": "限制 AI Agent 的工具权限：只读、改动需确认、或全权限自动执行。",
		"status_permission": "权限 %s",
		"confirm_title": "需要确认的工具调用",
		"apply": "应用",
		"reject": "拒绝",
		"always_allow": "本会话内自动允许相似低风险更改",
		"always_allow_command": "本会话内允许完全相同的 Shell 命令",
		...
		"recovery_dismissed": "已忽略恢复信息，会话历史已保留。",
		...
		"event_compact_started": "正在压缩会话历史…",
		...
		"event_cache_hit": "上下文缓存命中 · cached %s / %s tokens",
		"status_context_usage": "缓存 %s/%s",
	...
	"en": {
		...
		"permission_tooltip": "Limit AI Agent tool permissions: read-only, confirm changes, or full automatic access.",
		"status_permission": "permission %s",
		"confirm_title": "Confirm tool calls",
		"apply": "Apply",
		"reject": "Reject",
		"always_allow": "Always allow similar low-risk changes in this session",
		"always_allow_command": "Allow this exact Shell command in this session",
		...
		"recovery_dismissed": "Recovery dismissed; session history was preserved.",
		...
		"event_compact_started": "Compacting conversation history...",
		...
		"event_cache_hit": "Context cache hit · cached %s / %s tokens",
		"status_context_usage": "cache %s/%s",
		"event_tool_start": "%s(%s)",
