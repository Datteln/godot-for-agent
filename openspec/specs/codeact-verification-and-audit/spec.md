# codeact-verification-and-audit Specification

## Purpose

Define diff evidence, target-matched validation, map repair transparency, and bounded auditable evidence for CodeAct actions.
