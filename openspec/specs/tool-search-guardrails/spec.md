# tool-search-guardrails Specification

## Purpose

Define guardrails for `tool.search` to prevent endless re-searching and provide clear guidance when tools are not found. (TBD)
