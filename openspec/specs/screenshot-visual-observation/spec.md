# Screenshot Visual Observation Spec

## Purpose

Define how the system captures bounded, target-aware 2D and 3D screenshots, derives spatial facts from scene facts, normalizes eligible captures into visual-observation records, performs bounded multimodal observation when available, and delivers terminal, durable observation state consistently to model context and history with explicit cost and artifact-lifetime disclosure.
