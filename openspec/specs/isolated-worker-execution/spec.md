# isolated-worker-execution Specification

## Purpose

Define task-scoped, rootless, network-isolated Docker workers for shell, headless, and temporary-script execution, including allowed-root mounting and isolated Godot cache.
