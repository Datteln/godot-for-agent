# workspace-codeact-safety Specification

## Purpose

Define workspace path-root derivation, concurrent drift detection, and protection of open Editor files from worker writes.
